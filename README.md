...
```
cd existing_repo
git remote add origin https://git.tu-berlin.de/abdalla_eltayeb/insektroboter.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.tu-berlin.de/abdalla_eltayeb/insektroboter/-/settings/integrations)
